...
@interface ADWParser () <NSXMLParserDelegate>

// While parsing, this is the item currently being parsed
@property (nonatomic, strong) NSMutableDictionary *item;

// The element within that item being parsed
@property (nonatomic, strong) NSMutableString *elementValue;

@end


@implementation ADWParser
        ...
        attributes:(NSDictionary *)attributeDict
{
	if ([elementName isEqualToString:self.rowElementName])
    {
        ...
        for (NSString *attributeName in self.attributeNames)
        {
            ...
            if (attributeValue)
            {
                [self.item setObject:attributeValue
